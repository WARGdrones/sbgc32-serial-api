...
#define MAX_DEBUG_VARS_QUAN 10 /*!<  1 --> 255																		*/
	...
	typedef enum
	{
		...
		SSE_SUB_ERR_IMU_SENSOR_NOT_RESPONDING = 11, // Lost connection to IMU sensor
		...
		SSE_SUB_ERR_MOTOR_LOAD_TIME_EXCEEDED = 18, // Motors are fully loaded too long time
	...
	typedef enum
	{
		...
		CalibM_CALIB_MODE_SET_ANGLE_AND_SAVE = 2,
		CalibM_CALIB_MODE_POLES = 3,
		CalibM_CALIB_MODE_ACC = 4,
		CalibM_CALIB_MODE_GYRO = 5,
		CalibM_CALIB_MODE_ENCODER_OFFSET = 6,
		CalibM_CALIB_MODE_ENCODER_FLD_OFFSET = 7,
		...
		CalibM_CALIB_MODE_MOTOR_MAG_LINK = 15,
		CalibM_CALIB_MODE_SEARCH_LIMITS = 16,
		CalibM_CALIB_MODE_SET_OPERATION_POS = 17,
		CalibM_CALIB_MODE_IMU_ORIENTATION_CORR = 18,
		...
		CalibM_CALIB_MODE_GYRO_AXES_ALIGNMENT = 26,
		CalibM_CALIB_MODE_EXT_IMU_GYRO = 27,
		CalibM_CALIB_MODE_EXT_IMU_ALIGN = 28,
		CalibM_CALIB_MODE_ACC_GYRO_MULTIPOINT = 34
	...
	typedef enum
	{
		...
		SIMUA_RESET_ALL_CALIB_AND_RESTART = 2,
		SIMUA_TEMPERATURE_CALIBRATION = 3,
		SIMUA_ENABLE_TEMP_CALIB_DATA_IF_PRESENT = 4,
		SIMUA_DISABLE_TEMP_CALIB_DATA = 5,
		SIMUA_RESTORE_FACTORY_CALIB = 6,
		SIMUA_COPY_CALIB_FROM_MAIN_EEPROM = 7
	...
	typedef struct __PACKED__
	{
		...
		float scriptVarsFloat[3]; /*Script variables in floats*/
		i16 scriptVarsInt16[3];
		SystemPowerState_t systemPowerState;
		i16 frameCamRate[3];
	 ...
	 * 	@{
	 */
	TxRxStatus_t SBGC32_RequestRealTimeDataCustom(GeneralSBGC_t *generalSBGC, RealTimeDataCustom_t *realTimeDataCustom, ui32 flags);
	/**	@}
	 */
