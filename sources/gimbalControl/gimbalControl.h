...
#define ANGLE_TO_DEGREE_01_INT(val) \
	...
	typedef enum
	{
		/** Applicable for all modes
		   frw. ver. 2.70b5+ */
		CtrlF_CONTROL_FLAG_MIX_FOLLOW = BIT_4_SET,

		/** Applicable for CtrlM_MODE_ANGLE or CtrlM_MODE_ANGLE_REL_FRAME
		   frw. ver. 2.70b1+ */
		CtrlF_CONTROL_FLAG_TARGET_PRECISE = BIT_5_SET,
		/** Applicable for CtrlM_MODE_ANGLE or CtrlM_MODE_ANGLE_REL_FRAME
		   frw. ver. 2.62b7+ */
		...
		/** Applicable for CtrlM_MODE_RC
		   frw. ver. 2.62b7+ */
		CtrlF_CONTROL_FLAG_FORCE_RC_SPEED = BIT_6_SET,
		/** frw. ver. 2.60+ */
		CtrlF_CONTROL_FLAG_HIGH_RES_SPEED = BIT_7_SET
	...
	typedef enum
	{
		RTCCF_CONTROL_CONFIG_FLAG_CONFIRM = 0,
		RTCCF_CONTROL_CONFIG_FLAG_NO_CONFIRM = BIT_0_SET
